...
<!-- x -->
<!-- ```{r save as vector/pdf} -->
<!-- # Step 1: Call the pdf command to start the plot -->
<!-- pdf(file = "/Users/ginalamp/Desktop/model_11_w9_h7.pdf",   # The directory you want to save the file in -->
...
# Step 1: Call the pdf command to start the plot
pdf(file = "/Users/ginalamp/Desktop/model_11_w14_h9_labels_blanktitle.pdf",   # The directory you want to save the file in
...
# Step 1: Call the pdf command to start the plot
pdf(file = "/Users/ginalamp/Desktop/model_11_alone_2_2_10terms.pdf",   # The directory you want to save the file in
...
```{r}
plot(model, labels = seq_len(model$K))
```

```{r}
# This complains
# plot(model, which = 7:11, labels = c("topic 7", "topic 8", "topic 9", "topic 10", "topic 11"))
```

```{r plot first 9 topics with labels}
plot(model, which = 1:9, labels = 1:9)
```
...
```{r write non-vital results to files}
