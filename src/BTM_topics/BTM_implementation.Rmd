...
pdf(file = "model_11_labels_blanktitle.pdf", # The directory you want to save the file in
...
# Step 1: Call the pdf command to start the plot
pdf(file = "model_11.pdf",   # The directory you want to save the file in
    width = 15, # The width of the plot in inches
    height = 9) # The height of the plot in inches
...
# Step 1: Call the pdf command to start the plot
pdf(file = "model_11_alone_10terms.pdf",   # The directory you want to save the file in
